...
import com.workconnect.security.JWTConfigurer;
import com.workconnect.security.JWTFilter;
import com.workconnect.security.JwtAuthenticationEntryPoint;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(antMatcher("/auth/register/applicant")).permitAll()
                        .requestMatchers(antMatcher("/auth/register/company")).permitAll()
                        .requestMatchers(antMatcher("/mail/**")).permitAll()
                        //.requestMatchers(antMatcher("/mail/reset/check/**")).permitAll()
    ...
    public CorsFilter corsFilter() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:4200", "https://jobhub-api-latest.onrender.com"));
